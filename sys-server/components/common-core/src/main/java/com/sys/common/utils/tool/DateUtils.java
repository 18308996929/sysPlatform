package com.sys.common.utils.tool;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
     ...
     * @return
     */
    public static Date getBeforeMouth(Date date,int amount) {
        if(amount > 0)
        {
            return getAddDate(date, Calendar.MONTH, -1 * amount);
        }
        return getAddDate(date, Calendar.MONTH, amount);
    }
