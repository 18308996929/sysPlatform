...
import com.sys.common.utils.data.RedisUtils;
...
public class RedisCacheAutoConfiguration {
    ...
    public RedisTemplate redisTemplate(RedisConnectionFactory factory) {
        ...
        om.setSerializationInclusion(JsonInclude.Include.NON_NULL);// 只包含不为空的字段
        om.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);// 忽略在JSON字符串中存在，而在Java中不存在的属性
